  ...
  if(data.type === 'run'){
    ...
    try{
      ...
      setup += "\n" + [
        ...
        "            # No custom turtle icon is rendered (line-drawing only), but",
        "            # accepting/storing the name means scripts that call this don't crash.",
        "            if name is not None: self._shape = name",
        "            return getattr(self, '_shape', 'classic')",
        "        def shapesize(self, stretch_wid=None, stretch_len=None, outline=None): pass",
        "        turtlesize = shapesize",
        "        def resizemode(self, rmode=None): pass",
        "        def tilt(self, angle): pass",
        "        def settiltangle(self, angle): pass",
        "        def tiltangle(self, angle=None): return 0",
        "        def stamp(self):",
        "            _t_dot(self.x, self.y, max(self.pen_width + 4, 6) / 2, self.pen_color)",
        "            return 0",
        ...
        "        onkeypress = onkey; onkeyrelease = onkey",
        ...
        "    def shape(name=None): return _get_default().shape(name)",
        "    def shapesize(stretch_wid=None, stretch_len=None, outline=None): pass",
        "    def turtlesize(stretch_wid=None, stretch_len=None, outline=None): pass",
        "    def resizemode(rmode=None): pass",
        "    def tilt(angle): pass",
        "    def settiltangle(angle): pass",
        "    def tiltangle(angle=None): return 0",
        "    def stamp(): return _get_default().stamp()",
        "    def clearstamp(stampid): pass",
        "    def clearstamps(n=None): pass",
        ...
        "    def listen(): pass",
        "    def onkey(*a, **k): pass",
        "    def onkeypress(*a, **k): pass",
        "    def onkeyrelease(*a, **k): pass",
